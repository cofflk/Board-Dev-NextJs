...
//   const VIEW_TEMP_URL = BASE_URL + '/get/temp/';
//   const VIEW_URL = BASE_URL + '/get/';
...
//     preBtn.type = 'button';
//     preBtn.className = 'upload2-clear';
//     preBtn.textContent = '미리보기';
//     preBtn.addEventListener('click', function () {
//       showError('');
//       window.open(VIEW_TEMP_URL + item.tempData.id, '_blank');
//     });
//     filesEl.appendChild(preBtn);
